...
description: "Audit or establish the closed loop anchoring an agent's behavior to its intended value across four layers (Value, Governance, Runtime Prompt, Infrastructure); detects goal and value drift early."
metadata:
