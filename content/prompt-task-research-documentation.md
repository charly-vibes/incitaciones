...
# Research and Audit Documentation Architecture

## When to Use

Use this prompt when you need to **analyze existing documentation** or **plan a new documentation suite** using advanced information architecture frameworks (Diátaxis, EPPO, Snowflake).

**Critical for:**
- Auditing legacy documentation for cognitive friction.
- Mapping out the structural "Snowflake" outline for a new book or guide.
- Identifying gaps in the 4 Diátaxis quadrants (Tutorial, How-to, Reference, Explanation).
- Ensuring every page functions as an entry point (EPPO).
...
- A clear, quadrant-based map of the documentation.
- Identification of structural weaknesses (mixed intent, poor orientation).
