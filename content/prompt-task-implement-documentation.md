...
updated: 2026-07-29
version: 1.1.0
related: [research-documentation-frameworks.md, research-finding-library-docs-best-practices.md, prompt-workflow-implement-plan.md, research-finding-skill-progressive-disclosure.md]
source: project-internal
---

# Implement High-Signal Documentation Topics

## When to Use

Use this prompt to **write or rewrite specific documentation topics** following an architectural audit or plan.

**Critical for:**
- Writing Diátaxis-compliant topics (Tutorials, How-to's, Reference, Explanations).
- Applying Information Mapping (Chunking, Labeling) to reduce cognitive load.
- Creating "EPPO-ready" pages with standalone context.
- Implementing "AI-First" documentation structures (semantic labels, `llms.txt`).
...
- Documentation that is immediately actionable for humans.
- High-quality semantic data for RAG/AI ingestion.
...
The canonical theory remains `research-documentation-frameworks.md`; the references are operational excerpts that link back to it. The operational depth (templates, anti-patterns, tooling, versioning, rollout) is sourced from `research-finding-library-docs-best-practices.md`.
